...
<main>
    ...
    <section class = "forget_sec">
        <h1>계정 정보찾기</h1>
        <p>이메일 주소 또는 생년월일로 계정정보를 찾을 수 있습니다.</p>
        <form action="/finddo">
	        <table class = "forgt">
	            <tr>
	                <td><small>이메일 주소</small></td>
	                <td><input type="email" name="femail" id="femail" placeholder="이메일을 입력해주세요." required></td>
	            </tr>
	            <tr>
	                <td colspan="2">
	                    <input type="submit" class="forgetBtn" value="이메일로 계정정보 찾기 >">
	                </td>
	            </tr>
	            <tr>
		...
		<form action="">
			<table class = "forgt">
	            ...
	            <tr>
	                <td colspan="2"><input type="button" class="forgetBtn" value="생년월일로 계정정보 찾기 >"></td>
	            </tr>
	            <tr>
	                <td colspan="2" class = "centerline"/>      
	            </tr>
