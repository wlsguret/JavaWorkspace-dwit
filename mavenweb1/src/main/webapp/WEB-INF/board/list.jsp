		...
		<div class="container">
			...
			<form name=form action="/board/searchList" method=post>
				<div class="form-group">
					...
					<input onmouseover="this.focus()" type="text" 
					id="search" name="search" placeholder="찾을 내용을 입력하세요">
				...
				<tr>
					<td colspan=4 align=center valign="center" >
						<ul class="pagination" style="justify-content: center;">
							...
							<c:if test="${pageboard.requestPage>=6}">
								<li class="page-item"><a class="page-link"
									href="/board?requestPage=${pageboard.requestPage}&pagemove=-1">이전페이지</a></li>
							</c:if>
	
							<c:forEach var="i" begin="${pageboard.beginPage}"
								end="${pageboard.endPage}">
								<li class="page-item"><a class="page-link"
									href="/board?requestPage=${i}&pagemove=0">${i}</a></li>
							</c:forEach>
	
							<c:if test="${pageboard.totalPage-5>=pageboard.requestPage}">
								<li class="page-item"><a class="page-link"
									href="/board?requestPage=${pageboard.requestPage}&pagemove=1">다음페이지</a></li>
							</c:if>
